                ...
                if (@char.statusMe != 14 && @char.cHP > 0 || !@char.isWaitMonkey)
                {
                    ...
                    if (PickMob.tanSat)
                    {
                        ...
                        else
                        {
                            ...
                            if (@char.mobFocus == null)
                            {
                                ...
                                if (isTDLT && @char.mobFocus != null)
                                {
                                    if (PickMob.telePem)
                                    {
                                        ...
                                        {
                                            MainMod.MoveTo(@char.mobFocus.xFirst, @char.mobFocus.yFirst);
                                        }
                                        return;
                                    }
                            ...
                            if (@char.mobFocus != null)
                            {
                                if (true || @char.skillInfoPaint() == null)
                                {
                                    ...
                                    if (skillAttack != null && CanUseSkill(skillAttack))
                                    {
                                        ...
                                        if (Res.distance(mobFocus.xFirst, mobFocus.yFirst, @char.cx, @char.cy) <= 48)
                                        {
                                            ...
                                            {
                                                MainMod.MoveTo(mobFocus.xFirst, mobFocus.yFirst + 1);
                                            }
                                            if (skillAttack.template.isAttackSkill())
                                            {
                                                MainMod.GI().AttackMob(mobFocus);
                                                MainMod.GI().SetUsedSkill(@char.myskill);
                                            }
                                            else if (skillAttack.template.isUseAlone())
                                            {
                                                MainMod.GI().DoDoubleClickToObj(mobFocus);
                                            }
                                        }
                                        else
                                        {
                                            if (PickMob.telePem)
                                            {
                                                ...
                                                {
                                                    MainMod.MoveTo(mobFocus.xFirst, mobFocus.yFirst);
                                                }
                                                return;
                                            }
                                ...
                                if (!isTDLT)
                                {
                                    ...
                                    if (mobNext != null)
                                    {
                                        ...
                                        if (PickMob.telePem)
                                        {
                                            ...
                                            {
                                                MainMod.MoveTo(mobNext.xFirst, mobNext.yFirst);
                                            }
                                            return;
                                        }
                            ...
                            if (@char.charFocus == null)
                            {
                                ...
                                if (@char.charFocus != null)
                                {
                                    if (PickMob.telePem)
                                    {
                                        ...
                                        {
                                            MainMod.MoveTo(@char.charFocus.cx, @char.charFocus.cy);
                                        }
                                        return;
                                    }
                            ...
                            if (@char.charFocus != null)
                            {
                                if (@char.skillInfoPaint() == null)
                                {
                                    ...
                                    if (skillAttack != null && CanUseSkill(skillAttack))
                                    {
                                        ...
                                        {
                                            MainMod.GI().DoDoubleClickToObj(charFocus);
                                        }
                                        else
                                        {
                                            if (PickMob.telePem)
                                            {
                                                ...
                                                {
                                                    MainMod.MoveTo(charFocus.cx, charFocus.cy);
                                                }
                                                return;
                                            }
