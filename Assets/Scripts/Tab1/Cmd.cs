public class Cmd
{
    // -48 22 25 26 28 30 34 37 49 53 55 59 60 67 70 71 72 73 75 77 78 79 80 91 99 103 104 105 > 111 115 > 120 126
    ...
    public const sbyte CLAN_PARTY = -58; // EMPTY

    public const sbyte CLAN_INVITE = -57;

    public const sbyte CLAN_REMOTE = -56; // EMPTY

    public const sbyte CLAN_LEAVE = -55; // EMPTY

    public const sbyte CLAN_DONATE = -54; // EMPTY
    ...
    public const sbyte CLAN_JOIN = -49; // EMPTY
    ...
    public const sbyte CHECK_MOVE = -78; // EMPTY
    ...
    public const sbyte CHAT_PLAYER = -72; // EMPTY

    public const sbyte CHAT_THEGIOI_CLIENT = -71; // EMPTY
    ...
    public const sbyte GET_ITEM = -40; // EMPTY

    public const sbyte FINISH_LOADMAP = -39; // EMPTY

    public const sbyte FINISH_UPDATE = -38; // EMPTY
    ...
    public const sbyte MAP_OFFLINE = -33; // EMPTY
    ...
    public const sbyte ME_BACK = -15; // EMPTY
