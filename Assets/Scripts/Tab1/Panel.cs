...
public class Panel : IActionListener, IChatable
{
    ...
    public static string[] strCauhinh = new string[5]
    {
        ...
        GameCanvas.lowGraphic ?  mResources.cauhinhthap : mResources.cauhinhthap
    };
    ...
    public void updateKey()
    {
        ...
        else
        {
            ...
            if (Equals(GameCanvas.panel) && GameCanvas.panel2 == null
                && GameCanvas.isPointerJustRelease
                && !GameCanvas.isPointer(X, Y, W, H)
                && !pointerIsDowning)
            {
                if (MainMod.is2Tabs && GameCanvas.isPointer((GameCanvas.w - MainMod.logoW) / 2, 5, MainMod.logoW, MainMod.logoH))
                {
                    MainMod.GI().OpenMenu();
    ...
    private void updateKeyScrollView()
    {
        ...
        if ((isTabInven() || type == 13) && GameCanvas.py < yScroll)
        {
            selected = 0;
            updateKeyInvenTab();
        }
   ...
   private void setTabBox()
	{
		currentListLength = checkCurrentListLength(Char.myCharz().arrItemBox.Length / 5);
		ITEM_HEIGHT = 24;
		cmyLim = currentListLength * ITEM_HEIGHT - hScroll;
		if (cmyLim < 0)
		{
                        ...
                        if (typeShop == 2 && currentTabIndex <= 3 && !Equals(GameCanvas.panel2))
                        {
                            if (item.buyCoin > 0 && item.buyGold > 0)
                            {
                                if (item.buyCoin > 0)
                                {
                                    ...
                                    mFont2 = (Char.myCharz().thoiVang >= item.buyCoin) ? mFont.tahoma_7b_yellow : mFont.tahoma_7b_red;
                            ...
                            else
                            {
                                ...
                                try
                                {
                                    if (MainMod.readNameKiGui && !Char.myCharz().cName.Equals(item.nameNguoiKyGui))
                                    {
                                        mFont2 = mFont.tahoma_7b_green;
    ...
    private void paintSkill(mGraphics g)
    {
        ...
        for (int i = 0; i < num + 6; i++)
        {
            ...
            else
            {
                ...
                {
                    st6 = mResources.need_upper + " " + Res.formatNumber2(skill3.powRequire) + " " + mResources.potential_to_learn_Whis;
                }
    ...
    private void paintBox(mGraphics g)
    {
        ...
        try
        {
            ...
            currentListLength = checkCurrentListLength(arrItemBox.Length / 5);
            TAB_W_NEW = 1;
            int columns = 5;
            int itemWidth = 33;
            ...
            for (int i = 0; i < arrItemBox.Length; i++)
            {
                ...
                g.setColor(6047789, 0.4f);
                g.fillRect(num5, num6, num7, num8, 5, 5, 5, 5);
                if (item == null)
                {
                    continue;
                }
                ...
                if (item.itemOption != null)
                {
                    ...
                    {
                        g.setColor(6047789, 0.4f);
                        g.fillRect(num5 + 2, num6 + 2, num7 - 4, num8 - 4, 3, 3, 3, 3);
                        ...
                        if (item.itemOption[l].optionTemplate.id == 72)
                        {
                            // item.paintColorItem(g, num2 + 17, num3 + 12, item.itemOption[l].param);
                        }
    ...
    private void paintLogChat(mGraphics g)
    {
        ...
        for (int i = 0; i < currentListLength; i++)
        {
            ...
            {
                MainMod.PaintTicks(g, false, num4 + 4, num5);
            }
            else if (infoItem.charInfo.isTichXanh)
            {
                MainMod.PaintTicks(g, true, num4 + 4, num5);
            }
            //
    ...
    private void paintInventory(mGraphics g)
    {
        ...
        currentListLength = checkCurrentListLength(arrItemBody.Length + arrItemBag.Length / 5);
        TAB_W_NEW = 1;
        g.setClip(xScroll, yScroll, wScroll, hScroll);
        g.translate(0, -cmy);
        try
        {
            ...
            for (int j = 0; j < arrItemBody.Length; j++)
            {
                ...
                g.fillRect(x, y, wScroll, ITEM_HEIGHT - 1, 5, 5, 5, 5);
                ...
                if (item != null)
                {
                    for (int k = 0; k < item.itemOption.Length; k++)
                    {
                        ...
                        {
                            if (item.itemOption[k].param > 0)
                                paintItemStar(g, item.itemOption[k].param.ToString(), x + 125, y);
                        }
                    }
                }
                g.fillRect(num7, num8, num9, num10, 5, 5, 5, 5);             
                if (item != null && item.isSelect && GameCanvas.panel.type == 12)
                {
                ...
                if (item != null)
                {
                    ...
                    if (item.itemOption != null)
                    {
                        for (int l = 0; l < item.itemOption.Length; l++)
                        {
                            ...
                            {
                                if (item.itemOption[l].param > 0)
                                    paintItemStar(g, item.itemOption[l].param.ToString(), x + 125, y);
                            }
                            if (item.itemOption[l].optionTemplate.id == 41)
                            {
                                if (item.itemOption[l].param == 1)
                            ...
                            g.fillRect(num7 + 2, num8 + 2, num9 - 4, num10 - 4, 3, 3, 3, 3);
                        }
                    }
                    ...
                    if (item.itemOption != null)
                    {
                        ...
                        mFont3.drawString(g, text2, x + 5, y + 11, mFont.LEFT);
                    }
            ...
            // Vẽ các item bag (1 hàng 5 cột)
            for (int i = 0; i < arrItemBag.Length; i++)
            {
                int num9 = 33;
                int x = xScroll + (i % 5) * (num9 + 2);
                int y = bagStartY + (i / 5) * (ITEM_HEIGHT);
                int num7 = x;
                int num8 = y;
                int num10 = ITEM_HEIGHT - 1;
                if (y - cmy > yScroll + hScroll || y - cmy < yScroll - ITEM_HEIGHT) continue;
                ...
                if (i == inventorySelect_bag)
                {
                    ...
                    g.drawRect(x - 1, y - 1, num9 + 1, ITEM_HEIGHT); // Vẽ viền hình chữ nhật
                }
                ...
                g.fillRect(x, y, num9, num10, 5, 5, 5, 5);
                if (item != null && item.isSelect && GameCanvas.panel.type == 12)
                {
                ...
                if (item != null)
                {
                    if (item.itemOption != null)
                    {
                        ...
                        {
                            g.setColor(6047789, 0.2f);
                            g.fillRect(x + 2, y + 2, num9 - 4, num10 - 4, 3, 3, 3, 3);
                            if (item.itemOption[l].optionTemplate.id == 72)
                            {
                                // item.paintColorItem(g, num7 + 18, num8 + 12, item.itemOption[l].param);
                            }
                            ...
                            {
                                if (item.itemOption[l].param > 0)
                                    mFont.tahoma_7_white.drawStringBorder(g, item.itemOption[l].param.ToString() + "s", num7 + 25, num8 - 1, 0, mFont.tahoma_7_grey);
                            }
                            else
                            {
                    ...
                    if (item.quantity > 1)
                    {
                        mFont.tahoma_7_yellow.drawString(g, string.Empty + NinjaUtil.getMoneys(item.quantity), x + num9, y + num10 - mFont.tahoma_7_yellow.getHeight(), 1);
                    }
                }
            }
        }
    ...
    private void paintTab(mGraphics g)
    {
        if (type == 27)
        {
            ...
            mFont.tahoma_7b_dark.drawString(g, MainMod.strPlayerInfo, xScroll + wScroll / 2, 59, mFont.CENTER);
            return;
        }
        if (type == 23 || type == 24)
        {
        ...
        if (type == 19 || type == 26)
        {
            string s = type == 19 ? mResources.option : type == 26 ? MainMod.strModFunc : MainMod.strPlayerInfo;
            g.setColor(13524492);
            g.fillRect(X + 1, 78, W - 2, 1);
        ...
        if (type == 8)
        {
            mFont.tahoma_7b_dark.drawString(g, mResources.msg + MainMod.strClickToChat, startTabPos + TAB_W / 2, 59, mFont.CENTER);
            g.setColor(13524492);
            g.fillRect(X + 1, 78, W - 2, 1);
            return;
        }
    ...
    private void paintToolInfo(mGraphics g)
    {
        ...
        mFont.tahoma_7_yellow.drawString(g, (Char.myCharz().isTichDo ? "      " : Char.myCharz().isTichXanh ? "     " : string.Empty) + Char.myCharz().cName, 60, 16, mFont.LEFT, mFont.tahoma_7_grey);
        if (Char.myCharz().isTichDo)
        {
            MainMod.PaintTicks(g, false, 58, 17);
        }
        else if (Char.myCharz().isTichXanh)
        {
            MainMod.PaintTicks(g, true, 58, 17);
        }
    ...
    {
        mFont.tahoma_7b_white.drawString(g, (c.isTichDo ? "      " : c.isTichXanh ? "      " : string.Empty) + c.cName, X + 60, 4, mFont.LEFT, mFont.tahoma_7b_dark);
        if (c.isTichDo)
        {
            MainMod.PaintTicks(g, false, X + 60 - 1, 5 - 1);
        }
        else if (c.isTichXanh)
        {
            MainMod.PaintTicks(g, true, X + 60, 5 - 1);
        }
        if (c.cMaxStamina > 0)
        {
    ...
    private void doSpeacialSkill()
    {
        ...
        myVector8.addElement(new Command(MainMod.strChooseIntrinsic, this, 8011, info));
            ...
            if (currItem != null)
            {
                if (currItem.isBuySpec)
                {
                    if (currItem.buySpec > 0)
                    {
                        ...
                        myVector.addElement(new Command(MainMod.strAutoBuy, this, 3006, currItem));
                    }
                }
                else if (typeShop == 4)
                {
        ...
        else
        {
            ...
            if (isnewInventory && isnewInventory)
            {
                ...
                else if (currItem.isTypeBody())
                {
                    ...
                    {
                        myVector.addElement(new Command(MainMod.strUseForPet2, this, 2007, currItem));
                    }
                }
                else
                {
            ...
            if (currItem != null)
            {
                ...
                if (GameCanvas.panel.type != 12 && GameCanvas.panel.type != 13)
                {
                    if (position == 0)
                    {
                        ...
                        {
                            if (MainMod.listItemAuto.Exists(i => i.id == currItem.template.id))
                            {
                                myVector.addElement(new Command(MainMod.strRemoveAutoItem, MainMod.GI(), 501, currItem));
                            }
                            else
                            {
                                myVector.addElement(new Command(MainMod.strAddAutoItem, MainMod.GI(), 500, currItem));
                            }
                        }
                    }
                    if (position == 1)
    ...
    private void doFireLogMessage()
    {
        ...
        else if (selected >= 0 && logChat.size() != 0)
        {
            ...
            myVector.addElement(new Command(MainMod.strTeleportTo, this, 8004, infoItem.charInfo.charID));
            GameCanvas.menu.startAt(myVector, X, (selected + 1) * ITEM_HEIGHT - cmy + yScroll);
        ...
        try
        {
            ...
            else if (isViewMember)
            {
                ...
                if (currMem != null)
                {
                    ...
                    myVector4.addElement(new Command(MainMod.strTeleportTo, this, 8004, currMem.ID));
    ...
    private void doFireSkill()
    {
        ...
        if (selected == 0 || selected == 1 || selected == 2 || selected == 3 || selected == 4 || selected == 5)
        {
            ...
            if (selected == 0)
            {
                ...
                myVector.addElement(new Command(MainMod.strInCrease, MainMod.GI(), 100, selected + "-" + 16));
                GameCanvas.menu.startAt(myVector, X, (selected + 1) * ITEM_HEIGHT - cmy + yScroll);
    ...
    private void DoFirePetSkill()
    {
        ...
        {
            long cTiemNang = @char.cTiemNang;
            long cHPGoc = @char.cHPGoc;
            long cMPGoc = @char.cMPGoc;
            long cDamGoc = @char.cDamGoc;
            int cDefGoc = @char.cDefGoc;
            int cCriticalGoc = @char.cCriticalGoc;
            ...
            if (selected == 0)
            {
                ...
                if (cTiemNang > cHPGoc && cTiemNang < 10 * (2 * (cHPGoc + num2) + 180) / 2)
                {
                    GameCanvas.startYesNoDlg(mResources.use_potential_point_for1 + (cHPGoc + num2) + mResources.use_potential_point_for2 + Char.myCharz().hpFrom1000TiemNang + mResources.for_HP, new Command(mResources.increase_upper, this, 9000, typeChar), new Command(mResources.CANCEL, this, 4007, null));
                    return;
                }
                MyVector myVector = new(string.Empty);
                if (cTiemNang >= 10 * (2 * (cHPGoc + num2) + 180) / 2 && cTiemNang < 100 * (2 * (cHPGoc + num2) + 1980) / 2)
                {
                    myVector.addElement(new Command(mResources.increase_upper + "\n" + Char.myCharz().hpFrom1000TiemNang + mResources.HP + "\n-" + Res.formatNumber2(cHPGoc + num2), this, 9000, typeChar));
                    myVector.addElement(new Command(mResources.increase_upper + "\n" + 10 * Char.myCharz().hpFrom1000TiemNang + mResources.HP + "\n-" + Res.formatNumber2(10 * (2 * (cHPGoc + num2) + 180) / 2), this, 9006, typeChar));
                }
                else if (cTiemNang >= 100 * (2 * (cHPGoc + num2) + 1980) / 2)
                {
                    myVector.addElement(new Command(mResources.increase_upper + "\n" + Char.myCharz().hpFrom1000TiemNang + mResources.HP + "\n-" + Res.formatNumber2(cHPGoc + num2), this, 9000, typeChar));
                    myVector.addElement(new Command(mResources.increase_upper + "\n" + 10 * Char.myCharz().hpFrom1000TiemNang + mResources.HP + "\n-" + Res.formatNumber2(10 * (2 * (cHPGoc + num2) + 180) / 2), this, 9006, typeChar));
                    myVector.addElement(new Command(mResources.increase_upper + "\n" + 100 * Char.myCharz().hpFrom1000TiemNang + mResources.HP + "\n-" + Res.formatNumber2(100 * (2 * (cHPGoc + num2) + 1980) / 2), this, 9007, typeChar));

                }
                myVector.addElement(new Command(MainMod.strInCrease, MainMod.GI(), 100, selected + "-" + typeChar));
                GameCanvas.menu.startAt(myVector, X, (selected + 1) * ITEM_HEIGHT - cmy + yScroll);
                addSkillDetail2(selected, false);
            }
            if (selected == 1)
            {
                ...
                if (cTiemNang > cMPGoc && cTiemNang < 10 * (2 * (cMPGoc + num2) + 180) / 2)
                {
                    GameCanvas.startYesNoDlg(mResources.use_potential_point_for1 + (cMPGoc + num2) + mResources.use_potential_point_for2 + Char.myCharz().mpFrom1000TiemNang + mResources.for_KI, new Command(mResources.increase_upper, this, 9000, typeChar), new Command(mResources.CANCEL, this, 4007, null));
                    return;
                }
                MyVector myVector = new(string.Empty);
                if (cTiemNang >= 10 * (2 * (cMPGoc + num2) + 180) / 2 && cTiemNang < 100 * (2 * (cMPGoc + num2) + 1980) / 2)
                ...
                {
                    myVector.addElement(new Command(mResources.increase_upper + "\n" + Char.myCharz().mpFrom1000TiemNang + mResources.KI + "\n-" + Res.formatNumber2(cMPGoc + num2), this, 9000, typeChar));
                    myVector.addElement(new Command(mResources.increase_upper + "\n" + 10 * Char.myCharz().mpFrom1000TiemNang + mResources.KI + "\n-" + Res.formatNumber2(10 * (2 * (cMPGoc + num2) + 180) / 2), this, 9006, typeChar));
                    myVector.addElement(new Command(mResources.increase_upper + "\n" + 100 * Char.myCharz().mpFrom1000TiemNang + mResources.KI + "\n-" + Res.formatNumber2(100 * (2 * (cMPGoc + num2) + 1980) / 2), this, 9007, typeChar));
                }
                myVector.addElement(new Command(MainMod.strInCrease, MainMod.GI(), 100, selected + "-" + typeChar));
                GameCanvas.menu.startAt(myVector, X, (selected + 1) * ITEM_HEIGHT - cmy + yScroll);
                addSkillDetail2(selected, false);
            ...
            if (selected == 2)
            {
                ...
                if (cTiemNang > cDamGoc && cTiemNang < 10 * (2 * cDamGoc + 9) / 2 * Char.myCharz().expForOneAdd)
                {
                    GameCanvas.startYesNoDlg(mResources.use_potential_point_for1 + cDamGoc * 100 + mResources.use_potential_point_for2 + Char.myCharz().damFrom1000TiemNang + mResources.for_hit_point, new Command(mResources.increase_upper, this, 9000, typeChar), new Command(mResources.CANCEL, this, 4007, null));
                    return;
                }
                MyVector myVector = new(string.Empty);
                if (cTiemNang >= 10 * (2 * cDamGoc + 9) / 2 * Char.myCharz().expForOneAdd && cTiemNang < 100 * (2 * cDamGoc + 99) / 2 * Char.myCharz().expForOneAdd)
                {
                    myVector.addElement(new Command(mResources.increase_upper + "\n" + Char.myCharz().damFrom1000TiemNang + "\n" + mResources.hit_point + "\n-" + Res.formatNumber2(cDamGoc * 100), this, 9000, typeChar));
                    myVector.addElement(new Command(mResources.increase_upper + "\n" + 10 * Char.myCharz().damFrom1000TiemNang + "\n" + mResources.hit_point + "\n-" + Res.formatNumber2(10 * (2 * cDamGoc + 9) / 2 * Char.myCharz().expForOneAdd), this, 9006, typeChar));
                }
                else if (cTiemNang >= 100 * (2 * cDamGoc + 99) / 2 * Char.myCharz().expForOneAdd)
                {
                    myVector.addElement(new Command(mResources.increase_upper + "\n" + Char.myCharz().damFrom1000TiemNang + "\n" + mResources.hit_point + "\n-" + Res.formatNumber2(cDamGoc * 100), this, 9000, typeChar));
                    myVector.addElement(new Command(mResources.increase_upper + "\n" + 10 * Char.myCharz().damFrom1000TiemNang + "\n" + mResources.hit_point + "\n-" + Res.formatNumber2(10 * (2 * cDamGoc + 9) / 2 * Char.myCharz().expForOneAdd), this, 9006, typeChar));
                    myVector.addElement(new Command(mResources.increase_upper + "\n" + 100 * Char.myCharz().damFrom1000TiemNang + "\n" + mResources.hit_point + "\n-" + Res.formatNumber2(100 * (2 * cDamGoc + 99) / 2 * Char.myCharz().expForOneAdd), this, 9007, typeChar));
                }
                myVector.addElement(new Command(MainMod.strInCrease, MainMod.GI(), 100, selected + "-" + typeChar));
                GameCanvas.menu.startAt(myVector, X, (selected + 1) * ITEM_HEIGHT - cmy + yScroll);
                addSkillDetail2(selected, false);
            ...
            if (selected == 3)
            {
                ...
                long number3 = 100L * (2 * (cDefGoc + 5) + 99) / 2 * 100000;
                MyVector myVector = new(string.Empty);
                myVector.addElement(new Command(mResources.increase_upper + "\n1 " + mResources.armor + "\n" + Res.formatNumber2(number), this, 9000, typeChar));
                myVector.addElement(new Command(mResources.increase_upper + "\n10 " + mResources.armor + "\n" + Res.formatNumber2(number2), this, 9006, typeChar));
                myVector.addElement(new Command(mResources.increase_upper + "\n100 " + mResources.armor + "\n" + Res.formatNumber2(number3), this, 9007, typeChar));
                myVector.addElement(new Command(MainMod.strInCrease, MainMod.GI(), 100, selected + "-" + typeChar));
                GameCanvas.menu.startAt(myVector, X, (selected + 1) * ITEM_HEIGHT - cmy + yScroll);
                addSkillDetail2(selected, false);
            }
            else if (selected == 4)
            {
                ...
                GameCanvas.startYesNoDlg(mResources.use_potential_point_for1 + Res.formatNumber(num3) + mResources.use_potential_point_for2 + Char.myCharz().criticalFrom1000Tiemnang + mResources.for_crit, new Command(mResources.increase_upper, this, 9000, typeChar), new Command(mResources.CANCEL, this, 4007, null));
            }
            return;
        }
    ...
    public void perform(int idAction, object p)
    {
        if (idAction == 8010)
        {
            ...
            chatTField.parentScreen ??= this;
            MainMod.GI().MyChatTextField(chatTField, "Nhập số sao cần đập", "Chỉ được nhập số");
        }
        else if (idAction == 8011)
        {
            ...
            MainMod.curSelectIntrinsic = infoIntrinsic;
            MainMod.GI().MyChatTextField(chatTField, "Nhập chỉ số mong muốn", "Chỉ nhập số");
        }
        if (idAction == 9999)
        {
        ...
        {
            int charID = (int)p;
            MainMod.GI().TeleportToPlayer(charID);
        }
        if (idAction == 8001)
        {
        ...
        if (idAction == 9000)
        {
            ...
            Service.gI().upPotential(typeChar, selected, 1);
            GameCanvas.endDlg();
            InfoDlg.showWait();
        }
        if (idAction == 9006)
        {
            ...
            Service.gI().upPotential(typeChar, selected, 10);
            GameCanvas.endDlg();
            InfoDlg.showWait();
        }
        if (idAction == 9007)
        {
            ...
            Service.gI().upPotential(typeChar, selected, 100);
            GameCanvas.endDlg();
            InfoDlg.showWait();
        }
        if (idAction == 9002)
    ...
    public void onChatFromMe(string text, string to)
    {
        if (chatTField.strChat == "Nhập chỉ số mong muốn")
        {
            if (chatTField.tfChat.getText() != string.Empty)
            {
                ...
                if (success)
                {
                    MainMod.GI().SetAutoIntrinsic(param);
                }
                else
                {
        ...
        else if (chatTField.strChat == "Nhập số sao cần đập")
        {
            if (chatTField.tfChat.getText() != string.Empty)
            {
                ...
                if (success && maxPhale > 0)
                {
                    ...
                    {
                    "Đập ",
                    MainMod.itemPhale.template.name,
                    " đến ",
                    maxPhale,
                    " sao"
                    }), 0);
                    MainMod.maxPhale = maxPhale;
                }
                else
                {
        ...
        switch (selected)
        {
            ...
            case 4:
                if (!Main.isIPhone)
                {
                    ...
                    Rms.saveRMSInt("lowGraphic", GameCanvas.lowGraphic ? 1 : 0);
    ...
    private void DoFireModFunc()
    {
        ...
        {
            case 0:
                MainMod.isHighFps = !MainMod.isHighFps;
                MainMod.GI().ChangeFPSTarget();
                break;
            case 1:
                MainMod.GI().isUpdateZones = !MainMod.GI().isUpdateZones;
                break;
            case 2:
                MainMod.showCharsInMap = !MainMod.showCharsInMap;
                MainMod.SaveSettings();
                break;
            case 3:
                MainMod.showInfoPet = !MainMod.showInfoPet;
                break;
            case 4:
                if (Char.myCharz().xu < 1_000_000_000L)
                {
                    GameScr.info1.addInfo("Không đủ vàng để tự động pha lê hoá", 0);
                    return;
                }
                MainMod.isAutoPhaLe = !MainMod.isAutoPhaLe;
                if (MainMod.isAutoPhaLe)
                {
                    new Thread(new ThreadStart(MainMod.AutoPhaLe)).Start();
                }
                break;
            case 5:
                if (!MainMod.isAutoVQMM)
                {
                    hideNow();
                }
                MainMod.isAutoVQMM = !MainMod.isAutoVQMM;
                break;
            case 6:
                MainMod.GI().autoWakeUp = !MainMod.GI().autoWakeUp;
                break;
            case 7:
                if (MainMod.isAutoLogin)
                {
                    MainMod.isAutoLogin = false;
                    MainMod.autoLogin = null;
                }
                else
                {
                    MainMod.isAutoLogin = true;
                    MainMod.autoLogin = new AutoLogin
                    {
                ...
                break;
            case 8:
                MainMod.isShowQuickButton = !MainMod.isShowQuickButton;
                MainMod.SaveSettings();
                break;
            case 9:
                MainMod.isShowXMAPButton = !MainMod.isShowXMAPButton;
                MainMod.SaveSettings();
                break;
        }
        SoundMn.gI().GetStrModFunc();
