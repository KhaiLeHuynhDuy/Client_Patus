...
// 				return;
// 			}
// 			if (id < 0 || id >= MainMod.musics.Count)
// 			{
// 				id = 0;
// 			}
// 			if (isPlayingSoundBG(0) && !MainMod.isPlayingMusic)
// 			{
// 				sTopSoundBG();
// 			}
...
// 				SoundBGLoop.GetComponent<AudioSource>().clip = MainMod.musics[id];
// 				SoundBGLoop.GetComponent<AudioSource>().volume = 0.4f;
// 				SoundBGLoop.GetComponent<AudioSource>().Play();
// 				MainMod.isPlayingMusic = true;
// 			}
// 			else
// 			{
// 				SoundBGLoop.GetComponent<AudioSource>().Stop();
// 				MainMod.isPlayingMusic = false;
// 			}
// 		}
// 	}
