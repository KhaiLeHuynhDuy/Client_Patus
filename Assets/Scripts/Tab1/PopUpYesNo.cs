public class PopUpYesNo : IActionListener
{
	...
	public void paint(mGraphics g)
	{
		...
		if (info != null)
		{
			...
			{
				cmdYes.paint(g);
				mFont.tahoma_7b_dark.drawString(g, mResources.YES,
				cmdYes.x + cmdYes.img.getWidth() / 2 - mFont.tahoma_7b_dark.getWidth(mResources.YES) / 2,
				cmdYes.y + cmdYes.img.getHeight() / 2 - mFont.tahoma_7b_dark.getHeight() / 2, 0);
