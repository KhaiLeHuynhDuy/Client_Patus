...
public class Controller : IMessageHandler
{
        ...
        try
        {
            ...
            switch (msg.command)
            {
                ...
                case 112:
                    {
                        ...
                        if (type == 0)
                        {
                            ...
                            MainMod.GI().CheckAutoIntrinsic(Panel.specialInfo);
                        }
                        else
                        {
                            if (type != 1)
                ...
                case -95:
                    {
                        ...
                        if (type == 4)
                        {
                            ...
                            else
                            {
                                ...
                                EffecMn.addEff(new Effect(18, @char.cx, @char.cy, 2, 10, -1));
                            }
                            SoundMn.gI().explode_1();
                        }
                        if (type == 5)
                ...
                case -74:
                    {
                        ...
                        if (b38 == 2)
                        {
                            try
                            {
                                ...
                                string filename = "x" + mGraphics.zoomLevel + array8[^1];
                        ...
                        if (b38 == 3)
                        {
                            Rms.saveRMSInt("musicSize", MainMod.musicCount);
                            isLoadingData = false;
                ...
                case -46:
                    {
                        ...
                        if (type == 1 || type == 3)
                        {
                            ...
                            for (int i = 0; i < size; i++)
                            {
                                ...
                                // byte optSz = msg.reader().readUnsignedByte();
                                // if (optSz > 0)
                                // {
                                //     clanImage2.options = new ItemOption[optSz];
                                //     for (int j = 0; j < optSz; j++)
                                //     {
                                //         short num14 = msg.reader().readShort();
                                //         short param = msg.reader().readShort();
                                //         clanImage2.options[j] = new ItemOption(num14, param);
                                //     }
                                // }
                                ...
                                // ClanImage.getClanImage((short)clanImage2.ID).options = clanImage2.options;
                            }
                            if (Char.myCharz().clan != null)
                            {
                ...
                case 3:
                    {
                        ...
                        Char.MyPet2z().cHPGoc = hpg;
                        Char.MyPet2z().cMPGoc = mpg;
                        Char.MyPet2z().cDamGoc = dameg;
                        Char.MyPet2z().cDefGoc = defg;
                        Char.MyPet2z().cCriticalGoc = critg;
                ...
                case -36:
                    {
                        ...
                        if (b7 == 0)
                        {
                            ...
                            for (int j = 0; j < num11; j++)
                            {
                                ...
                                if (num12 == 457)
                                {
                                    Char.myCharz().thoiVang = Char.myCharz().arrItemBag[j].quantity;
                                }
                ...
                case -44:
                    {
                        ...
                        for (int i = 0; i < tabSz; i++)
                        {
                            ...
                            for (int num61 = 0; num61 < itemSz; num61++)
                            {
                                ...
                                {
                                    Char.myCharz().arrItemShop[i][num61].nameNguoiKyGui = msg.reader().readUTF();
                                }
                            }
                        }
                        if (flag5)
                ...
                case -67:
                    {
                        ...
                        // if (data != null && mGraphics.zoomLevel > 1)
                        if (data != null)
                        {
                            Rms.saveRMS(mGraphics.zoomLevel + "Small" + iconId, data);
                            sbyte[] newArr = MainMod.DecryptBytes(data);
                            SmallImage.imgNew[iconId].img = createImage(newArr);
                        }
                        break;
                    }
                case -66:
                    {
                        ...
                        sbyte[] newArr = MainMod.DecryptBytes(array15);
                        effDataById.img = Image.createImage(newArr, 0, newArr.Length);
                        break;
                    }
                case -32:
                    {
                        ...
                        if (array11 != null)
                        {
                            ...
                            // }
                            Rms.saveRMS(mGraphics.zoomLevel + "bgItem" + num131, array11);
                            sbyte[] newArr = MainMod.DecryptBytes(array11);
                            image = Image.createImage(newArr, 0, num132);
                            BgItem.imgNew.put(num131 + string.Empty, image);
                ...
                case -26:
                    ...
                    {
                        MainMod.indexAutoPoint = -1;
                        MainMod.pointIncrease = 0;
                        MainMod.typePointForPet = 16;
                    ...
                    if (MainMod.autoLogin != null)
                    {
                        MainMod.autoLogin.waitToNextLogin = false;
                    }
                    break;
                case -25:
                ...
                case 32:
                    {
                        ...
                        for (int i = 0; i < GameScr.vNpc.size(); i++)
                        {
                            ...
                            if (npc.template.npcTemplateId == npcId && npc.Equals(Char.myCharz().npcFocus))
                            {
                                ...
                                {
                                    MainMod.maxPhale = MainMod.currPhale;
                                }
                ...
                for (int m = 0; m < num6; m++)
                {
                    ...
                    if (TileMap.getBIById(num7) != null)
                    {
                        ...
                        if (!BgItem.imgNew.containsKey(bgItem.idImage + string.Empty))
                        {
                            ...
                            if (array != null)
                            {
                                sbyte[] newArr = MainMod.DecryptBytes(array);
                                if (BgItem.newSmallVersion != null)
                                {
                                    if (newArr.Length % 127 != BgItem.newSmallVersion[bgItem.idImage])
                                    {
                                        flag2 = true;
                                    }
                                }
                                if (!flag2)
                                {
                                    image = Image.createImage(newArr, 0, newArr.Length);
                                    if (image != null)
                                    {
                                        BgItem.imgNew.put(bgItem.idImage + string.Empty, image);
                                    }
    ...
    public void LoadAuraNpcs(Message msg)
    {
        ...
        for (sbyte i = 0; i < sz; i++)
        {
            ...
            Npc npc = MainMod.GetNpcByTempId(npcId);
            if (npc != null)
            {
                npc.idAura = auraId;
            }
    ...
    public void messageNotLogin(Message msg)
    {
        try
        {
            ...
            {
                bool resEncrypted = msg.reader().readBool();
                MainMod.resEncrypted = resEncrypted;
        ...
        try
        {
            ...
            switch (b)
            {
                case 63:
                    {
                        sbyte b5 = msg.reader().readByte();
                        if (b5 > 0 && Char.myCharz().charFocus != null)
                        {
                ...
                case 0:
                    {
                        ...
                        try
                        {
                            Char.myCharz().isTichDo = msg.reader().readByte() == 1;
                        }
                        catch
                        {
                        }
    ...
    public void read_UpdateSkill(Message msg)
    {
        try
        {
            ...
            else
            {
                ...
                Skill skill3 = Skills.get(skillId);
