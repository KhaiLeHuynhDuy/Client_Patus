...
public class mGraphics2
{
	...
	private void cache(string key, Texture value)
	{
		...
		if (value.width * value.height < GameCanvas2.w * GameCanvas2.h)
		{
	...
	public void setBgColor(int rgb)
	{
		if (rgb != currentBGColor)
		{
			...
			g = (float)num2 / 256f;
			r = (float)num3 / 256f;
			Main2.main.GetComponent<Camera>().backgroundColor = new Color(r, g, b);
		}
	}
	...
	public void drawString(string s, int x, int y, GUIStyle style)
	{
		...
		GUI.Label(new Rect(x - num, y - num2, ScaleGUI2.WIDTH, 100f), s, style);
		if (isClip)
		{
			GUI.EndGroup();
		}
	...
	public void drawRegion(Image2 arg0, int x0, int y0, int w0, int h0, int arg5, int x, int y, int arg8)
	{
		if (arg0 != null)
		{
			x *= zoomLevel;
	...
	public void drawRegion(Image2 arg0, long x0, long y0, int w0, int h0, int arg5, int x, int y, int arg8)
	{
		if (arg0 != null)
		{
			x *= zoomLevel;
	...
	public void drawRegion(Image2 arg0, int x0, int y0, int w0, int h0, int arg5, float x, float y, int arg8)
	{
		if (arg0 != null)
		{
			x *= (float)zoomLevel;
	...
	public void drawRegion(Image2 arg0, int x0, int y0, int w0, int h0, int arg5, int x, int y, int arg8, bool isClip)
	{
		drawRegion(arg0, x0, y0, w0, h0, arg5, x, y, arg8);
	}

	public void __drawRegion(Image2 image, int x0, int y0, int w, int h, int transform, float x, float y, int anchor)
	{
		if (image == null)
		{
			return;
	...
	public void _drawRegion(Image2 image, float x0, float y0, int w, int h, int transform, int x, int y, int anchor)
	{
		if (image == null)
		{
			return;
	...
	public void drawRegionGui(Image2 image, float x0, float y0, int w, int h, int transform, float x, float y, int anchor)
	{
	...
	public void drawRegion2(Image2 image, float x0, float y0, int w, int h, int transform, int x, int y, int anchor)
	{
		...
		if (texture2D == null)
		{
			Image2 image2 = Image2.createImage(image, (int)x0, (int)y0, w, h, transform);
	...
	public void drawImagaByDrawTexture(Image2 image, float x, float y)
	{
		x *= (float)zoomLevel;
		y *= (float)zoomLevel;
	...
	public void drawImage(Image2 image, int x, int y, int anchor)
	{
		if (image != null)
		{
	...
	public void drawImageFog(Image2 image, int x, int y, int anchor)
	{
		if (image != null)
		{
	...
	public void drawImage(Image2 image, int x, int y)
	{
		if (image != null)
		{
	...
	public void drawImage(Image2 image, float x, float y, int anchor)
	{
		if (image != null)
		{
			drawRegion(image, 0, 0, getImageWidth(image), getImageHeight(image), 0, x, y, anchor);
	...
	public void drawImageScale(Image2 image, int x, int y, int w, int h, int tranform)
	{
		x *= zoomLevel;
		y *= zoomLevel;
		w *= zoomLevel;
	...
	public void drawImageScale(Image2 image, int x, int y, int w, int h)
	{
		x *= zoomLevel;
		y *= zoomLevel;
		w *= zoomLevel;
	...
	public void drawImageSimple(Image2 image, int x, int y)
	{
		x *= zoomLevel;
		y *= zoomLevel;
		if (image != null)
	...
	public static Image2 blend(Image2 img0, float level, int rgb)
	{
		int num = rgb & 0xFF;
		int num2 = (rgb >> 8) & 0xFF;
		int num3 = (rgb >> 16) & 0xFF;
		...
		Image2 image = Image2.createImage(img0.getRealImageWidth(), img0.getRealImageHeight());
		image.texture.SetPixels(pixels);
		Image2.setTextureQuality(image.texture);
		image.texture.Apply();
		Cout2.LogError2("BLEND ----------------------------------------------------");
		return image;
	}
	...
	public void fillTrans(Image2 imgTrans, int x, int y, int w, int h)
	{
		setColor(0, 0.5f);
	...
	public static int getRealImageWidth(Image2 img)
	{
		return img.w;
	}

	public static int getRealImageHeight(Image2 img)
	{
		return img.h;
	}
	...
	public void DrawLine(int x1, int y1, int x2, int y2, int nLine)
	{
		...
		Graphics.DrawTexture(new Rect(vector.x - num5, vector.y - num4 - num6, vector3.magnitude, nLine), texture2D);
		if (isClip)
		{
			GUI.EndGroup();
		}
	...
	internal void drawRegion(Small2 img, int p1, int p2, int p3, int p4, int transform, int x, int y, int anchor)
	{
