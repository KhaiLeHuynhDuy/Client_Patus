...
public class BachTuoc2 : Mob2, IMapObject2
{
    ...
    public BachTuoc2(int id, short px, short py, int templateID, int hp, int maxHp, int s)
    {
        mobId = id;
        xFirst = (x = px + 20);
        yFirst = (y = py);
    ...
    public BachTuoc2(int id, short px, short py, int templateID, long hp, long maxHp, int s)
    {
        mobId = id;
        xFirst = (x = px + 20);
        yFirst = (y = py);
    ...
    public void getDataB()
    {
        ...
        string patch = "/x" + mGraphics2.zoomLevel + "/effectdata/" + 108 + "/data";
        try
        {
            data.readData2(patch);
            data.img = GameCanvas2.loadImage("/effectdata/" + 108 + "/img.png");
        }
        catch (Exception)
        {
