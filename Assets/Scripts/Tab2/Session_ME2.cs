...
public class Session_ME2_2 : ISession2
{
	public class Sender
	{
	...
	private class MessageCollector
	{
		...
		private Message2 readMessage()
		{
			try
			{
				...
				if (b == -28 || b == -32 || b == -66 || b == 11 || b == -67 || b == -74 || b == -87)
				{
	...
	protected static Session_ME2_2 instance = new Session_ME2_2();
	...
	public static Session_ME2_2 gI()
	{
		if (instance == null)
		{
			instance = new Session_ME2_2();
		}
		return instance;
	}
	...
	public static void update()
	{
		...
		{
			Message2 message = (Message2)recieveMsg[0];
