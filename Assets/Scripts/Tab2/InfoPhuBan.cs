public class InfoPhuBan2
{
	...
	public MyVector2 vecInfo = new MyVector2("vecInfo chientruong");

	public InfoPhuBan2(int type_PB, short idmapPaint, string nameTeam1, string nameTeam2, int maxPoint, short timeSecond)
	{
