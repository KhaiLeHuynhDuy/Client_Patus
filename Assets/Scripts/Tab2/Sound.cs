...
// 	public static void setActivity(SoundMn2.AssetManager ac)
// 	{
// 	}
...
// 	{
// 		if (!isNotPlay && GameCanvas2.isPlaySound)
// 		{
// 			start(volume, id);
// 		}
// 	}
...
// 	{
// 		if (GameCanvas2.isPlaySound && !(SoundRun == null))
// 		{
...
// 	{
// 		if (GameCanvas2.isPlaySound && !(SoundBGLoop == null))
// 		{
...
// 		if (status != 0)
// 		{
// 			Cout2.LogError("CANNOT LOAD AUDIO " + filename + " WHEN LOADING " + filenametemp);
// 			return;
// 		}
...
// 		if (i == 100)
// 		{
// 			Cout2.LogError("TOO LONG FOR LOAD AUDIO " + filename);
// 			return;
// 		}
// 		Cout2.Log("Load Audio " + filename + " done in " + i * 5 + "ms");
// 	}
