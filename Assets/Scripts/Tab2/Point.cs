public class Point2
{
	...
	public static FrameImage2[] FraEffInMap;

	public FrameImage2 fraImgEff;

	public FrameImage2 fraImgEff_2;
	...
	public Point2(int x, int y, int goc)
	{
		this.x = x;
		this.y = y;
		this.goc = goc;
	...
	{
		int frameAngle = Res2.angle(dx, dy);
	...
	public void moveTo_xy(int toX, int toY)
	{
		...
		if (num > 1)
		{
			int frameAngle = Res2.angle(num, dy);
			frame = setFrameAngle(frameAngle);
		}
		if (Res2.abs(vx) > 0)
		{
	...
	public void paint_Arrow(mGraphics2 g, FrameImage2 frm, int anchor, bool isCountFr)
	{
		if (frm != null)
		{
