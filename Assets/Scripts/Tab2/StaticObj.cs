...
{
	public static int TOP_CENTER = mGraphics2.TOP | mGraphics2.HCENTER;

	public static int TOP_LEFT = mGraphics2.TOP | mGraphics2.LEFT;

	public static int TOP_RIGHT = mGraphics2.TOP | mGraphics2.RIGHT;

	public static int BOTTOM_HCENTER = mGraphics2.BOTTOM | mGraphics2.HCENTER;

	public static int BOTTOM_LEFT = mGraphics2.BOTTOM | mGraphics2.LEFT;

	public static int BOTTOM_RIGHT = mGraphics2.BOTTOM | mGraphics2.RIGHT;

	public static int VCENTER_HCENTER = mGraphics2.VCENTER | mGraphics2.HCENTER;

	public static int VCENTER_LEFT = mGraphics2.VCENTER | mGraphics2.LEFT;
