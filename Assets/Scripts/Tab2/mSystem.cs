...
public class mSystem2
{
	...
	public static mSystem2 instance;
	...
	public static int getWidth(Image2 img)
	{
		if (clientType == 5)
		{
			return img.getWidth();
	...
	public static int getHeight(Image2 img)
	{
		if (clientType == 5)
		{
	...
	{
		Application.OpenURL(ServerListScreen2.linkweb);
	}
	...
	public static void paintPopUp2(mGraphics2 g, int x, int y, int w, int h)
	{
	...
	public static mSystem2 gI()
	{
		if (instance == null)
		{
			instance = new mSystem2();
		}
		return instance;
	}
	...
	{
		Controller2_.isConnectOK = true;
	}

	public static void onConnectionFail()
	{
		Controller2_.isConnectionFail = true;
	}

	public static void onDisconnected()
	{
		Controller2_.isDisconnected = true;
	}
	...
	public static void paintFlyText(mGraphics2 g)
	{
		for (int i = 0; i < 5; i++)
		{
			if (GameScr2.flyTextState[i] != -1 && GameCanvas2.isPaint(GameScr2.flyTextX[i], GameScr2.flyTextY[i]))
			{
				if (GameScr2.flyTextColor[i] == mFont2.RED)
				{
					mFont2.bigNumber_red.drawStringBorder(g, GameScr2.flyTextString[i], GameScr2.flyTextX[i], GameScr2.flyTextY[i], mFont2.CENTER);
				}
				else if (GameScr2.flyTextColor[i] == mFont2.YELLOW)
				{
					mFont2.bigNumber_yellow.drawStringBorder(g, GameScr2.flyTextString[i], GameScr2.flyTextX[i], GameScr2.flyTextY[i], mFont2.CENTER);
				}
				else if (GameScr2.flyTextColor[i] == mFont2.GREEN)
				{
					mFont2.bigNumber_green.drawStringBorder(g, GameScr2.flyTextString[i], GameScr2.flyTextX[i], GameScr2.flyTextY[i], mFont2.CENTER);
				}
				else if (GameScr2.flyTextColor[i] == mFont2.FATAL)
				{
					mFont2.bigNumber_yellow.drawStringBorder(g, GameScr2.flyTextString[i], GameScr2.flyTextX[i], GameScr2.flyTextY[i], mFont2.CENTER, mFont2.bigNumber_black);
				}
				else if (GameScr2.flyTextColor[i] == mFont2.FATAL_ME)
				{
					mFont2.bigNumber_green.drawStringBorder(g, GameScr2.flyTextString[i], GameScr2.flyTextX[i], GameScr2.flyTextY[i], mFont2.CENTER, mFont2.bigNumber_black);
				}
				else if (GameScr2.flyTextColor[i] == mFont2.MISS)
				{
					mFont2.bigNumber_While.drawStringBorder(g, GameScr2.flyTextString[i], GameScr2.flyTextX[i], GameScr2.flyTextY[i], mFont2.CENTER, mFont2.tahoma_7_grey);
				}
				else if (GameScr2.flyTextColor[i] == mFont2.ORANGE)
				{
					mFont2.bigNumber_orange.drawStringBorder(g, GameScr2.flyTextString[i], GameScr2.flyTextX[i], GameScr2.flyTextY[i], mFont2.CENTER);
				}
				else if (GameScr2.flyTextColor[i] == mFont2.ADDMONEY)
				{
					mFont2.bigNumber_yellow.drawStringBorder(g, GameScr2.flyTextString[i], GameScr2.flyTextX[i], GameScr2.flyTextY[i], mFont2.CENTER, mFont2.bigNumber_black);
				}
				else if (GameScr2.flyTextColor[i] == mFont2.MISS_ME)
				{
					mFont2.bigNumber_While.drawStringBorder(g, GameScr2.flyTextString[i], GameScr2.flyTextX[i], GameScr2.flyTextY[i], mFont2.CENTER, mFont2.bigNumber_black);
				}
				else if (GameScr2.flyTextColor[i] == mFont2.HP)
				{
					mFont2.bigNumber_red.drawStringBorder(g, GameScr2.flyTextString[i], GameScr2.flyTextX[i], GameScr2.flyTextY[i], mFont2.CENTER, mFont2.bigNumber_black);
				}
				else if (GameScr2.flyTextColor[i] == mFont2.MP)
				{
					mFont2.bigNumber_blue.drawStringBorder(g, GameScr2.flyTextString[i], GameScr2.flyTextX[i], GameScr2.flyTextY[i], mFont2.CENTER, mFont2.bigNumber_black);
				}
			}
		}
	}
	...
	public static FrameImage2 getFraImage(string nameImg)
	{
		FrameImage2 result = null;
		MainImage2 mainImage = null;
		if (mainImage == null)
		{
			mainImage = ImgByName2.getImagePath(nameImg, ImgByName2.hashImagePath);
		}
		if (mainImage.img != null)
		{
			...
			result = new FrameImage2(mainImage.img, mainImage.img.getWidth(), num);
		}
		return result;
	}
	...
	{
		return GameCanvas2.loadImage(path);
	}
}
