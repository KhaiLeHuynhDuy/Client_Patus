public class Arrow2
{
	...
	public Arrow2(Char2 charBelong, Arrowpaint2 arrp)
	{
	...
	public void paint(mGraphics2 g)
	{
		int dx = axTo - ax;
		int num = ayTo - ay;
		int num2 = findDirIndexFromAngle(Res2.angle(dx, -num));
		SmallImage2.drawSmallImage(g, arrp.imgId[FRAME[num2]], ax, ay, TRANSFORM[num2], mGraphics2.VCENTER | mGraphics2.HCENTER);
	}
